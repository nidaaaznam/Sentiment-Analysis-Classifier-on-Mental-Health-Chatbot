...
def send():
    ...
    if msg != '':
        ...
        sent_msg = [msg]
        emotion_pred = sentiment_response(sent_msg).split()[0].lower()
        ...
        ChatLog.insert(END, "Bot: It seems like based on my emotion prediction, you are currently feeling '" + emotion_cond + "'"+'\n\n')
